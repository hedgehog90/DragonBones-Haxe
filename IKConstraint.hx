...
public function new(data:IKData,armatureData:Armature)
{
	this.ikdata = data;
...
public function compute1 (bone:Bone, target:Bone, weightA:Float) : Void {
...
public function compute2(parent:Bone, child:Bone, targetX:Float,targetY:Float, bendDirection:Int, weightA:Float):Point
{
	//添加斜切后的算法，现在用的
	if (weightA == 0) {

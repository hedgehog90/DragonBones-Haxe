...
public static function parseTextureAtlasData(rawData:XML, scale:Float = 1):Object
{
	...
	var rotated:Bool = subTextureXML.@[ConstValues.A_ROTATED] == "true";
	
	var frameWidth:Float = int(subTextureXML.@[ConstValues.A_FRAME_WIDTH]) / scale;
	var frameHeight:Float = int(subTextureXML.@[ConstValues.A_FRAME_HEIGHT]) / scale;

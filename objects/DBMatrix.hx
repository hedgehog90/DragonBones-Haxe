...
class DBMatrix {
	...
	private static var __identity = new DBMatrix ();
	private static var __temp = new DBMatrix ();
	...
	public function clone ():DBMatrix {
		
		return new DBMatrix (a, b, c, d, tx, ty);
		
	}
	
	public function concat (m:DBMatrix):Void {
	...
	public function copyFrom (sourceMatrix:DBMatrix):Void {
	...
	public function deltaTransformPoint (point:DBPoint):DBPoint {
		
		return new DBPoint (point.x * a + point.y * c, point.x * b + point.y * d);
	...
	public function invert ():DBMatrix {
	...
	public function transformPoint (pos:DBPoint):DBPoint {
		
		return new DBPoint (__transformX (pos.x, pos.y), __transformY (pos.x, pos.y));
	...
	public inline function __transformInversePoint (point:DBPoint):Void {
	...
	public inline function __transformPoint (point:DBPoint):Void {

...
public static function parseSkeletonData(rawData:Object, ifSkipAnimationData:Bool=false, outputAnimationDictionary:Dictionary = null):DragonBonesData
{
	if(!rawData)
	{
...
private static function parseArmatureData(armatureObject:Object, data:DragonBonesData, frameRate:UInt, isGlobalData:Bool, ifSkipAnimationData:Bool, outputAnimationDictionary:Dictionary):ArmatureData
{
...
private static function parseBoneData(boneObject:Object, isGlobalData:Bool):BoneData
{
...
/** @private */
dragonBones_internal static function parseAnimationData(animationObject:Object, armatureData:ArmatureData, frameRate:UInt, isGlobalData:Bool):AnimationData
{
	...
	var displayIndexChangeSlotTimelines:Vector<SlotTimeline> = new Vector();
	var displayIndexChangeTimelines:Vector<TransformTimeline> = new Vector();
	var lastFrameDuration:Int = animationData.duration;
	var displayIndexChange:Bool;
	 ...
	 * 此时autoTween就不起任何作用了
	 */
	var animationTween:Float = animationData.tweenEasing;
...
private static function parseSlotTimeline(timelineObject:Object, duration:Int, frameRate:UInt, isGlobalData:Bool):SlotTimeline
{
...
private static function parseSlotFrame(frameObject:Object, frameRate:UInt, isGlobalData:Bool):SlotFrame
{
...
private static function parseTransformTimeline(timelineObject:Object, duration:Int, frameRate:UInt, isGlobalData:Bool):TransformTimeline
{
...
private static function parseTransformFrame(frameObject:Object, frameRate:UInt, isGlobalData:Bool):TransformFrame
{

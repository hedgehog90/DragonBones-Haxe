 ...
 * @author sukui
 */
final import flash.Error;

class XML3DataParser 
{
 ...
 */
public static function parseSkeletonData(rawData:XML, ifSkipAnimationData:Bool = false, outputAnimationDictionary:Dictionary = null):DragonBonesData
{
	if(!rawData)
	{
...
private static function parseArmatureData(armatureXML:XML, data:DragonBonesData, frameRate:UInt, isGlobalData:Bool, ifSkipAnimationData:Bool, outputAnimationDictionary:Dictionary):ArmatureData
{
...
/** @private */
dragonBones_internal static function parseAnimationData(animationXML:XML, armatureData:ArmatureData, frameRate:UInt, isGlobalData:Bool):AnimationData
{
...
private static function parseSlotTimeline(timelineXML:XML, duration:Int, frameRate:UInt, isGlobalData:Bool):SlotTimeline
{
...
private static function parseSlotFrame(frameXML:XML, frameRate:UInt, isGlobalData:Bool):SlotFrame
{

...
dragonBones_private var _armature:FastArmature;
...
dragonBones_private var _fadeTotalTime:Float;
...
/** @private */
dragonBones_private function fadeIn(aniData:AnimationData, playTimes:Float, timeScale:Float, fadeTotalTime:Float):Void
{
 ...
 */
dragonBones_private function updateTimelineStateList():Void
{	
	resetTimelineStateList();
